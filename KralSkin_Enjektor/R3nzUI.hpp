...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Text = L"Enjekte Durumu";
			// 
			// groupBox2
			// 
			...
			this->groupBox2->Text = L"Istemci Durumu";
			// 
			// label4
			// 
			...
			this->groupBox3->Text = L"Oyun Durumu";
			// 
			// groupBox4
			// 
			...
			this->groupBox4->Text = L"KralSkin Durumu";
			// 
			// linkLabel1
			// 
			...
			this->linkLabel1->Text = L"Copyright (c) 2022 = Kral";
...
#ifdef _RIOT
			this->Text = L"KralSkin";
#else
			this->Text = L"KralSkin Chin";
#endif
	...
	private:
		System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
		{
			...
			if (btnState) {
				...
				this->button1->Text = L"Durdur";
				this->label1->Text = L"Calisiyor!";
			} else {
